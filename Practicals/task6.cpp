...
class min_d
{
    ...
    public:
        min_d() = default; 
        min_d(int x1,int x2,int y1,int y2);       
        int get_x1();
        int get_y1();
        int get_x2();
        int get_y2();
        float shord(bool msg);

};


min_d::min_d(int x1,int x2,int y1,int y2)  //get all pt perm give direct sol print
{    
    this->x2 = x2 ;
    this->y1 = y1 ;
    this->y2 = y2 ;
...
float min_d::shord(bool msg=true)
{
    float x1 = get_x1() ;
    float y1 = get_y1() ;
    float x2 = get_x2() ;
